Quando scriviamo gli algoritmi in pseudocodice, lo facciamo per garantire una maggiore espressività e concisione. Se necessario possiamo anche scrivere in linguaggio naturale.  
